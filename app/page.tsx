  ...
  return (
    <>
      ...
      {/* ══════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════ */}
      <section style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', minHeight: isMobile ? 'auto' : '100vh', background: '#1A1814', paddingTop: '72px' }}>
        {/* Left: editorial text panel */}
        <div style={{
          flex: isMobile ? 'none' : '0 0 44%',
          display: 'flex', flexDirection: 'column',
          justifyContent: 'center', padding: isMobile ? '48px 20px 40px' : isTablet ? '60px 40px' : '80px 64px',
          ...
          <div>
            ...
            <h1 className="reveal d1" style={{
              ...
              fontSize: isMobile ? '52px' : 'clamp(64px, 6vw, 96px)',
          ...
          <div className="reveal d4" style={{
            ...
            display: 'flex', gap: isMobile ? '24px' : '40px', borderTop: '1px solid rgba(245,240,232,0.08)',
          }}>
            {[{ n: '+20', l: 'Certified Factories' }, { n: '100%', l: 'Export Quality' }, { n: '0', l: 'Middlemen' }].map(s => (
              <div key={s.n}>
                <div style={{
                  fontFamily: "'Cormorant Garamond', serif", fontSize: isMobile ? '24px' : '30px',
        ...
        {/* Right: image panel */}
        <div style={{ flex: 1, position: 'relative', overflow: 'hidden', minHeight: isMobile ? '60vw' : 'auto' }}>
          ...
          {/* Floating mini card — hide on mobile */}
          {!isMobile && (
            <div style={{
          ...
          <div style={{
            position: 'absolute', top: isMobile ? '16px' : '40px', right: isMobile ? '16px' : '40px',
      ...
      {/* ══════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════ */}
      <section style={{ position: 'relative', height: isMobile ? '60vh' : '80vh', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          textAlign: 'center', padding: `0 ${isMobile ? '20px' : '48px'}`, gap: '28px',
        }}>
          ...
          <h2 className="reveal d1" style={{
            fontFamily: "'Cormorant Garamond', serif",
            fontSize: isMobile ? '48px' : 'clamp(56px, 8vw, 112px)',
            fontWeight: 300, fontStyle: 'italic',
      ...
      <section style={{ background: '#FAFAF8', padding: '3px' }}>
        {isMobile ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
            {/* Left tall cell */}
            <div className="img-zoom reveal" style={{ position: 'relative', background: '#E8E2D8', overflow: 'hidden', height: '320px' }}>
              ...
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '24px' }}>
                <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: '9px', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.7)', display: 'block', marginBottom: '8px' }}>Women</span>
                <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '26px', fontWeight: 300, fontStyle: 'italic', color: '#F5F0E8', lineHeight: 1.1, marginBottom: '12px' }}>The Women's Edit</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px' }}>
              <div className="img-zoom reveal" style={{ position: 'relative', background: '#D6CFC3', overflow: 'hidden', height: '200px' }}>
                ...
                <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '16px' }}>
                  <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: '9px', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.7)', display: 'block', marginBottom: '6px' }}>Men</span>
                  <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '20px', fontWeight: 300, fontStyle: 'italic', color: '#F5F0E8', lineHeight: 1.1 }}>Men's Edit</h3>
                </div>
              </div>
              <div className="img-zoom reveal" style={{ position: 'relative', background: '#2A2620', overflow: 'hidden', height: '200px' }}>
                ...
                <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '16px' }}>
                  <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: '9px', letterSpacing: '0.22em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.7)', display: 'block', marginBottom: '6px' }}>Essentials</span>
                  <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '20px', fontWeight: 300, fontStyle: 'italic', color: '#F5F0E8', lineHeight: 1.1 }}>Essentials</h3>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ══════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════ */}
      <section style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', minHeight: isMobile ? 'auto' : '600px', background: '#FAFAF8' }}>
        {/* Dark left panel */}
        <div style={{
          flex: isMobile ? 'none' : '0 0 46%', background: '#1A1814',
          display: 'flex', flexDirection: 'column',
          justifyContent: 'center', padding: isMobile ? '48px 20px' : isTablet ? '64px 40px' : '80px 64px', gap: '32px',
        }}>
          <span className="eyebrow reveal" style={{ color: 'rgba(196,168,130,0.7)' }}>Egypt's First</span>
          <h2 className="reveal d1" style={{
            fontFamily: "'Cormorant Garamond', serif",
            fontSize: isMobile ? '36px' : 'clamp(40px, 4vw, 60px)',
            fontWeight: 300, fontStyle: 'italic',
        ...
        {/* Right image */}
        <div className="img-zoom reveal-right" style={{ flex: 1, position: 'relative', overflow: 'hidden', background: '#E8E2D8', minHeight: isMobile ? '60vw' : 'auto' }}>
      ...
      {/* ══════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════ */}
      <section style={{ background: '#F5F0E8', padding: `${isMobile ? '56px' : '88px'} 0 0` }}>
        <div style={{ padding: `0 ${px}`, maxWidth: '1440px', margin: '0 auto' }}>
          {/* Header */}
          <div className="reveal" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '48px', gap: '24px', flexWrap: 'wrap' }}>
            <div>
              <span className="eyebrow" style={{ marginBottom: '12px' }}>Season 2025</span>
              <h2 style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: isMobile ? '36px' : 'clamp(36px, 4vw, 54px)',
                fontWeight: 300, fontStyle: 'italic',
                color: '#1A1814', lineHeight: 1.0,
              }}>New Arrivals</h2>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
              <div style={{ flex: 1, height: '1px', background: 'rgba(26,24,20,0.1)', minWidth: '40px' }} />
        ...
        {/* Grid */}
        <div style={{ padding: `0 ${px}`, maxWidth: '1440px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : isTablet ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: '3px' }}>
        ...
        <div className="reveal" style={{ textAlign: 'center', padding: `${isMobile ? '40px' : '56px'} ${px} ${isMobile ? '56px' : '88px'}`, maxWidth: '1440px', margin: '0 auto' }}>
      ...
      <section style={{ position: 'relative', minHeight: isMobile ? '50vh' : '70vh', overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{
          ...
          <div className="reveal d3" style={{ display: 'flex', justifyContent: 'center', gap: isMobile ? '32px' : '64px', marginTop: '56px', flexWrap: 'wrap' }}>
            {[{ n: '+20', l: 'Partner Factories' }, { n: '100%', l: 'Export Grade' }, { n: '15%', l: 'Group Savings' }].map(s => (
              <div key={s.n} style={{ textAlign: 'center' }}>
                <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: isMobile ? '32px' : '40px', fontWeight: 300, fontStyle: 'italic', color: '#C4A882', lineHeight: 1 }}>{s.n}</div>
      ...
      <section style={{ background: '#1A1814', padding: '3px 0', display: 'flex', gap: '3px', overflow: 'hidden' }}>
        {[
          ...
          { src: '/qom/6.jpg' },
          { src: '/qom/43.jpg' },
        ].slice(0, isMobile ? 3 : 5).map(({ src }) => (
          <div key={src} className="img-zoom reveal" style={{
            flex: 1, height: isMobile ? '40vw' : '460px', position: 'relative', overflow: 'hidden',
      ...
      <section style={{ background: '#FAFAF8', padding: `${isMobile ? '64px' : '96px'} ${px}` }}>
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          {/* Header */}
          <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: '24px', marginBottom: isMobile ? '48px' : '72px', flexWrap: 'wrap' }}>
            <h2 style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontSize: isMobile ? '36px' : 'clamp(36px, 3.5vw, 48px)',
              fontWeight: 300, fontStyle: 'italic', color: '#1A1814', whiteSpace: 'nowrap',
            }}>How It Works</h2>
            {!isMobile && <div style={{ flex: 1, height: '1px', background: 'rgba(26,24,20,0.1)' }} />}
            <Link href="/how-it-works" className="btn-ghost">Full Guide</Link>
          </div>

          {/* Steps */}
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : isTablet ? '1fr 1fr' : '1fr 1fr 1fr', gap: isMobile ? '48px' : '64px' }}>
            {[
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '3px' }}>
            {[
              ...
              <div key={name} style={{ background: dark ? '#1A1814' : '#FFFFFF', overflow: 'hidden', display: 'flex', flexDirection: 'column' }} className="reveal">
                <div className="img-zoom" style={{ height: isMobile ? '60vw' : '420px', position: 'relative', overflow: 'hidden' }}>
                  ...
                  <div style={{ position: 'absolute', top: '22px', left: '22px', background: dark ? '#C4A882' : 'rgba(250,250,248,0.92)', padding: '5px 14px' }}>
                    <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: '9px', fontWeight: 500, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#1A1814' }}>{tag}</span>
                  </div>
                </div>
                <div style={{ padding: isMobile ? '24px 20px' : '36px 40px', display: 'flex', flexDirection: 'column', gap: '12px', flex: 1 }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: `${isMobile ? '64px' : '88px'} ${px}`, maxWidth: '1440px', margin: '0 auto' }}>
          <div className="reveal" style={{ marginBottom: '56px' }}>
            <span className="eyebrow eyebrow-light">Why QOM</span>
            <h2 className="h-display h-display-light" style={{ fontSize: isMobile ? '32px' : 'clamp(32px,4vw,48px)', marginTop: '12px', maxWidth: '480px' }}>More Than Just Clothes</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : isTablet ? '1fr 1fr' : '1fr 1fr 1fr', gap: '2px' }}>
            {[
              ...
              <div key={p.title} className={`reveal d${i + 1}`} style={{
                ...
                padding: isMobile ? '32px 20px' : '40px 36px', display: 'flex', flexDirection: 'column', gap: '14px',
              }}>
      ...
      {/* ══════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════ */}
      <section style={{ background: '#1A1814', padding: `${isMobile ? '64px' : '88px'} ${px}`, textAlign: 'center' }}>
        <div style={{ maxWidth: '560px', margin: '0 auto' }}>
          ...
          <form className="reveal d3" onSubmit={e => e.preventDefault()} style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? '8px' : '0', maxWidth: '440px', margin: '0 auto' }}>
            <input
              type="email"
              ...
              style={{
                ...
                borderRight: isMobile ? '1px solid rgba(245,240,232,0.15)' : 'none',
