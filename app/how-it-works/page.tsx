...
export default function HowItWorksPage() {
  ...
  return (
    <>
      ...
      {/* ── Hero ─────────────────────────────────────────── */}
      <section style={{ background: '#1A1814', padding: '140px 64px 96px' }}>
      ...
      {STEPS.map((step, i) => (
        <section key={step.n} style={{
          display: 'flex', minHeight: '580px',
          background: i % 2 === 0 ? '#FAFAF8' : '#F5F0E8',
        }}>
          {/* Text panel */}
          <div className={i === 1 ? 'reveal-right' : 'reveal-left'} style={{
            flex: '0 0 44%',
            ...
            <span style={{
              fontFamily: "'Cormorant Garamond',serif",
              fontSize: '100px', fontWeight: 300, fontStyle: 'italic',
          ...
          {/* Image panel */}
          <div className={`img-zoom ${i === 1 ? 'reveal-left' : 'reveal-right'}`} style={{
            flex: 1, overflow: 'hidden', position: 'relative',
            background: '#E8E2D8', order: i === 1 ? 0 : 2,
          }}>
      ...
      <section style={{ background: '#FAFAF8', padding: '96px 64px' }}>
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: '56px' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 'clamp(32px,4vw,48px)', fontWeight: 300, fontStyle: 'italic', color: '#1A1814' }}>Two Ways to Shop</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3px' }}>
            {[
              ...
              <div key={name} className="reveal" style={{ background: dark ? '#1A1814' : '#FFFFFF', padding: '56px 48px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <span style={{
                ...
                <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '40px', fontWeight: 300, fontStyle: 'italic', color: dark ? '#F5F0E8' : '#1A1814' }}>{name}</h3>
      ...
      <section style={{ background: '#F5F0E8', padding: '96px 64px' }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          <div className="reveal" style={{ marginBottom: '56px' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 'clamp(32px,4vw,48px)', fontWeight: 300, fontStyle: 'italic', color: '#1A1814' }}>Frequently Asked</h2>
          </div>
            ...
            {FAQ.map((item, i) => (
              <div key={i} className="reveal" style={{ borderTop: '1px solid rgba(26,24,20,0.1)' }}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} style={{
                  ...
                  <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '20px', fontWeight: 400, color: '#1A1814', lineHeight: 1.3 }}>{item.q}</span>
                  <span style={{
      ...
      <section style={{ position: 'relative', overflow: 'hidden', minHeight: '420px', display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, width: '100%', textAlign: 'center', padding: '80px 64px' }}>
