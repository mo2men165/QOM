...
export default function Footer() {
  return (
    <footer style={{ background: '#1A1814', color: '#F5F0E8' }}>
      {/* Main footer body */}
      <div style={{ padding: '72px 64px 56px', maxWidth: '1440px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '48px', alignItems: 'start' }}>
          {/* Brand column */}
      ...
      {/* Bottom bar */}
      <div style={{ borderTop: '1px solid rgba(245,240,232,0.07)', padding: '24px 64px', maxWidth: '1440px', margin: '0 auto' }}>
